...
def send_summary_email(execution_time, article_title):
    ...
    while attempt < retries:
        try:
            ...
            if attempt < retries:
                ...
                return "Error generating article.", "Unknown Title"

# Run the script
if __name__ == "__main__":
    logging.info("Script execution started.")
    script_start_time = time.time()
    article_content, article_title = generate_article()
    ...
    if "Error generating article." not in article_content:
        ...
        send_summary_email(total_execution_time, article_title)
    else:
